    ...
    <div className="App">
      ...
      <div className={classes.wrapper}>
        ...
        <Typography variant="h5" className={classes.littleSpace} color="primary">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas a delectus maiores atque? Debitis, ut ad excepturi, totam voluptate saepe dolore dolor tempora harum porro fuga sunt numquam error facere, in ducimus quidem obcaecati eos! Eius ut ducimus facere voluptate quo perferendis impedit iusto tempore debitis error? Odit, nulla ea?
        </Typography>        
      </div>
